              ...
              <tbody>
                @foreach($coupons as $coupon)
                  <tr class="gradeX">
                    ...
                    <td class="center">
                       <a href="{{ url('/admin/edit-coupon/'.$coupon->id) }}" title="Edit Coupons" class="btn btn-primary btn-mini">Edit</a> 
                       <a id="delcoupon" rel="{{ $coupon->id }}" rel1="delete-coupon" href="javascript:" title="Delete Coupons" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
