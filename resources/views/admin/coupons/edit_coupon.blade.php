...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/edit-product') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Coupons</a> <a href="#" class="current">Edit Coupons</a> </div>
    <h1>Coupons</h1>
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('/admin/edit-coupon/'.$couponDetails->id) }}" name="edit_coupon" id="edit_coupon"> @csrf
              ...
              <div class="control-group">
                 ...
                 <div class="controls">
                  <select class="required" name="amount_type" id="amount_type" style="width: 220px;">
