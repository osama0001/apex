...
<head>
    <title>Apex Admin</title><meta charset="UTF-8" />
...
<div id="loginbox">
    ...
    <form id="loginform" class="form-vertical" method="post" action="{{ url('admin') }}"> @csrf
        <div class="control-group normal_text"> <h3><img width="250px" src="{{ asset('images/backend_images/logo.png') }}" alt="Logo" /></h3></div>
