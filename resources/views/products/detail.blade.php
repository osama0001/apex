		...
		<div class="row">
			...
			<div class="col-sm-9 padding-right">
				<div class="product-details"><!--product-details-->
							  ...
							  <!-- Wrapper for slides -->
							    <div class="carousel-inner">
									<div class="item active thumbnails">
										<a href="{{ asset('images/backend_images/products/large/'.$productDetails->image) }}" data-standard="{{ asset('images/backend_images/products/small/'.$productDetails->image) }}"><img class="changeImage" style="width:80px; cursor:pointer;" src="{{ asset('images/backend_images/products/small/'.$productDetails->image) }}" alt=""></a>
					...
					<div class="col-sm-7">
						<form action="{{ url('add-cart') }}" name="addtocartForm" id="addtocartForm" method="post"> @csrf
							...
							<div class="product-information"><!--/product-information-->
								...
								<p>
									<select id="selSize" name="size" style="width:120px;" required="">
				...
				<div class="category-tab shop-details-tab"><!--category-tab-->
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade" id="delivery" >
							<div class="col-sm-12">
								<p>100% orignal products <br> Cash on delivery</p>
							</div>
						</div>
